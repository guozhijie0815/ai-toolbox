...
| 平台 | 安装包 | 说明 |
|------|--------|------|
| macOS Apple Silicon | `AI Toolbox_0.2.0_aarch64.dmg` | 适用于 M 系列芯片 Mac |
| Windows | `AI Toolbox_0.2.0_*.exe` / `AI Toolbox_0.2.0_*.msi` | 适用于 64 位 Windows |
...
推送 `v*` 格式的 Git tag 会触发 GitHub Actions 自动构建安装包，并创建草稿 Release。
